...
# For All Files:
All files will have a variable **show_console** and will by default set to **False**.
If you would like to see the console, or debug a script for any purposes, just edit the variable to **True**.
